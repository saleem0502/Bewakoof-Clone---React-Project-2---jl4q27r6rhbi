      ...
      <Box width="75%" height="auto" display="flex" flexDirection="column">
        ...
        >
          <Box
            ...
            height="auto"
            gap="40px">
            <Box sx={boxStyle} onClick={() => navigate("/orders")}>
              <Typography variant="h6" sx={headingStyle}>
                My Orders <KeyboardArrowRightIcon sx={iconStyle} />
              </Typography>
              <Typography>View, modify and track orders</Typography>
            </Box>
            <Box sx={boxStyle}>
              <Typography variant="h6" sx={headingStyle}>
                My Payments <KeyboardArrowRightIcon sx={iconStyle} />
              </Typography>
              <Typography>View, modify and payment methods</Typography>
            </Box>
            <Box sx={boxStyle}>
              <Typography variant="h6" sx={headingStyle}>
                My Wallet Rs.0 <KeyboardArrowRightIcon sx={iconStyle} />
              </Typography>
              <Typography>
          ...
          <Box
            ...
            <Box sx={boxStyle}>
              <Typography variant="h6" sx={headingStyle}>
                My Address <KeyboardArrowRightIcon sx={iconStyle} />
              </Typography>
              <Typography>Edit, add or remove address</Typography>
            </Box>
            <Box sx={boxStyle}>
              <Typography
                variant="h6"
                ...
                My Profile <KeyboardArrowRightIcon sx={iconStyle} />
              </Typography>
              <Typography>Edit personal info, change password</Typography>
            </Box>
            <Box sx={boxStyle}>
              <Typography variant="h6" sx={headingStyle}>
                Refer and Earn <KeyboardArrowRightIcon sx={iconStyle} />
              </Typography>
